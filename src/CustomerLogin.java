...
public class CustomerLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/help-40.png"))); // NOI18N
        ...
        {   try
            {
                ...
                if(rs.next())
                {
                    ...
                    {
                        errMsg.setText("Your account is blocked. Contact Support Team.");
                    }
                    else
                    {
                        setVisible(false);
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        CustomerLoginSupport ob = new CustomerLoginSupport();
        ob.setVisible(true);
